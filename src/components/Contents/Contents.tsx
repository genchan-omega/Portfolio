...
export default function Contents(props: Props) {
  return (
    <div className="w-64 h-20 flex items-center justify-center rounded-lg transition-transform duration-300 hover:scale-110 border-2 border-cyan-100 p-0 overflow-hidden group">
