		...
		<div className="flex flex-col w-full mx-auto">
			...
			<div className="flex flex-col justify-center items-center gap-20 w-full">
				...
				<Timelinecard
					...
					title="応用情報技術者試験合格"
					date="2024/7"
					description="応用情報技術者試験に合格しました．本気の勉強をしてぎりぎり合格だったので，かなり危ない橋を渡ったと思います．とはいえ，一発合格をもぎとれたのはでかい．"
				/>
				<Timelinecard
					src="/timeline/ipa.png"
					title="基本情報技術者試験合格"
					date="2023/11"
					description="基本情報技術者試験に合格しました．情報全般に渡って体系だった学習をしたのは初めてだったので，新鮮な気持ちで取り組めました．テクノロジ系以外の勉強が辛かった...．"
				/>
				<Timelinecard
					src="/timeline/univ.png"
					title="大学入学"
