	...
	return (
		<div>
			...
			<div className="flex flex-col justify-center items-center w-full mx-auto">
				<h2 className="text-5xl font-bold underline text-center">Basic Info</h2>
				<figure className="flex flex-row justify-center items-center p-5 gap-5">
					<div className="p-1 rounded-4xl bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500">
						<Image
							...
							className="max-w-xs rounded-4xl shadow-md bg-white p-1"
						/>
					</div>
				...
				<h2 className="text-5xl font-bold underline text-center">skills</h2>
        ...
        <h2 className="text-5xl font-bold underline text-center">Qualifications</h2>
        <div className="p-5">
          <p>
            基本情報技術者<br/>
            応用情報技術者
